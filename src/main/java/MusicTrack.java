...
public class MusicTrack extends Node {
   ...
   MusicTrack(Buffer var1) {
      ...
      var51.method2634(1297377380);
      var51.method2634(6);
      var51.method2778(var2 > 1 ? 1 : 0);
      var51.method2778(var2);
      var51.method2778(var3);
      var1.offset = var13;
      int var52 = 0;
      int var53 = 0;
      int var54 = 0;
      ...
      for(int var60 = 0; var60 < var2; ++var60) {
         ...
         while(true) {
            while(true) {
               ...
               if (var64 == 7) {
                  if (var65) {
                     var51.method2631(255);
                  }

                  var51.method2631(47);
                  var51.method2631(0);
                  var51.method2748(var51.offset - var61);
                  continue label244;
               }
               ...
               if (var64 == 23) {
                  ...
                  var51.method2631(81);
                  var51.method2631(3);
                  var51.method2631(var1.array[var50++]);
                  var51.method2631(var1.array[var50++]);
                  var51.method2631(var1.array[var50++]);
               } else {
                  var52 ^= var64 >> 4;
                  if (var62 == 0) {
                     if (var65) {
                        var51.method2631(var52 + 144);
                     }

                     var53 += var1.array[var37++];
                     var54 += var1.array[var38++];
                     var51.method2631(var53 & 127);
                     var51.method2631(var54 & 127);
                  } else if (var62 == 1) {
                     if (var65) {
                        var51.method2631(var52 + 128);
                     }

                     var53 += var1.array[var37++];
                     var55 += var1.array[var40++];
                     var51.method2631(var53 & 127);
                     var51.method2631(var55 & 127);
                  } else if (var62 == 2) {
                     if (var65) {
                        var51.method2631(var52 + 176);
                     }

                     var28 = var28 + var1.array[var15++] & 127;
                     var51.method2631(var28);
                     byte var66;
                     if (var28 != 0 && var28 != 32) {
                        if (var28 == 1) {
                     ...
                     var59[var28] = var67;
                     var51.method2631(var67 & 127);
                  } else if (var62 == 3) {
                     if (var65) {
                        var51.method2631(var52 + 224);
                     }

                     var56 += var1.array[var45++];
                     var56 += var1.array[var33++] << 7;
                     var51.method2631(var56 & 127);
                     var51.method2631(var56 >> 7 & 127);
                  } else if (var62 == 4) {
                     if (var65) {
                        var51.method2631(var52 + 208);
                     }

                     var57 += var1.array[var32++];
                     var51.method2631(var57 & 127);
                  } else if (var62 == 5) {
                     if (var65) {
                        var51.method2631(var52 + 160);
                     }

                     var53 += var1.array[var37++];
                     var58 += var1.array[var31++];
                     var51.method2631(var53 & 127);
                     var51.method2631(var58 & 127);
                  } else {
                     if (var62 != 6) {
                        throw new RuntimeException();
                     }
                     ...
                     if (var65) {
                        var51.method2631(var52 + 192);
                     }

                     var51.method2631(var1.array[var44++]);
                  }
               }
            }
         }
   ...
   void method2895() {
      if (this.table == null) {
         ...
         int var5 = var4.method3068();

         int var6;
         for(var6 = 0; var6 < var5; ++var6) {
            var4.method3070(var6);
            var4.method3073(var6);
            var4.method3071(var6);
         }

         label56:
         do {
            while(true) {
               var6 = var4.method3087();
               int var7 = var4.trackLengths[var6];

               while(var7 == var4.trackLengths[var6]) {
                  var4.method3070(var6);
                  int var8 = var4.method3074(var6);
                  if (var8 == 1) {
                     var4.method3083();
                     var4.method3071(var6);
                     continue label56;
                  ...
                  if (var9 == 144) {
                     ...
                     if (var12 > 0) {
                        ...
                        ByteArrayNode var14 = (ByteArrayNode)this.table.method3512((long)var13);
                        if (var14 == null) {
                           var14 = new ByteArrayNode(new byte[128]);
                           this.table.method3517(var14, (long)var13);
                        }
