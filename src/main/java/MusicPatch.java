   ...
   MusicPatch(byte[] var1) {
      ...
      for(var23 = 0; var23 < 128; ++var23) {
         if (var20 == 0) {
            ...
            var22 = var2.method2660();
         }

         this.field2352[var23] = (short)(this.field2352[var23] + ((var22 - 1 & 2) << 14));
         this.field2357[var23] = var22;
         --var20;
      }
      ...
      for(var24 = 0; var24 < 128; ++var24) {
         if (this.field2357[var24] != 0) {
            ...
            this.field2356[var24] = (byte)var23;
            --var20;
         }
      }
      ...
      for(int var25 = 0; var25 < 128; ++var25) {
         if (this.field2357[var25] != 0) {
            ...
            this.field2360[var25] = (byte)var24;
            --var20;
         }
      }
      ...
      for(var27 = 0; var27 < 128; ++var27) {
         ...
         this.field2353[var27] = (byte)var26;
         --var20;
      }
      ...
      if (var42 != null) {
         ...
         for(var29 = 0; var29 < var47; ++var29) {
            this.field2353[var29] = (byte)(var28 * this.field2353[var29] + 32 >> 6);
         }
         ...
         for(var29 = 2; var29 < var42.length; var29 += 2) {
            ...
            for(var33 = var47; var33 < var30; ++var33) {
               var34 = PlatformInfo.method3200(var32, var30 - var47);
               this.field2353[var33] = (byte)(var34 * this.field2353[var33] + 32 >> 6);
               var32 += var31 - var28;
            }
         ...
         for(var45 = var47; var45 < 128; ++var45) {
            this.field2353[var45] = (byte)(var28 * this.field2353[var45] + 32 >> 6);
         }
      ...
      if (var16 != null) {
         ...
         for(var29 = 0; var29 < var47; ++var29) {
            var45 = var44 + (this.field2360[var29] & 255);
            if (var45 < 0) {
               var45 = 0;
            }
            ...
            this.field2360[var29] = (byte)var45;
         }
         ...
         for(var29 = 2; var29 < var16.length; var29 += 2) {
            ...
            for(var33 = var47; var33 < var30; ++var33) {
               var34 = PlatformInfo.method3200(var32, var30 - var47);
               int var35 = var34 + (this.field2360[var33] & 255);
               if (var35 < 0) {
                  var35 = 0;
               }
               ...
               this.field2360[var33] = (byte)var35;
               var32 += var46 - var44;
            }
         ...
         for(var45 = var47; var45 < 128; ++var45) {
            var46 = var44 + (this.field2360[var45] & 255);
            if (var46 < 0) {
               var46 = 0;
            }
            ...
            this.field2360[var45] = (byte)var46;
         }
   ...
   boolean method2907(SoundCache var1, byte[] var2, int[] var3) {
      ...
      for(int var7 = 0; var7 < 128; ++var7) {
         if (var2 == null || var2[var7] != 0) {
            int var8 = this.field2357[var7];
            if (var8 != 0) {
               if (var5 != var8) {
                  var5 = var8--;
                  if ((var8 & 1) == 0) {
                     var6 = var1.method1370(var8 >> 2, var3);
                  } else {
                     var6 = var1.method1358(var8 >> 2, var3);
                  }
