...
public class PcmPlayer {
      ...
      if (this.samples != null) {
         ...
         try {
            ...
            while(var1 > this.timeMs + 5000L) {
               this.method1231(256);
               this.timeMs += (long)(256000 / field1099);
            }
   ...
   public static FloorOverlayDefinition method1225(int var0) {
      FloorOverlayDefinition var1 = (FloorOverlayDefinition)FloorOverlayDefinition.HitSplatDefinition_cachedSprites.method3474((long)var0);
      if (var1 != null) {
         return var1;
      } else {
         ...
         var1.method808();
         FloorOverlayDefinition.HitSplatDefinition_cachedSprites.method3473(var1, (long)var0);
         return var1;
      }
   }
}
