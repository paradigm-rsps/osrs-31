            ...
            if (this.faceColors3[var4] != -2) {
               ...
               if (var1 && (var8 == -5000 || var9 == -5000 || var25 == -5000)) {
                  ...
                  if ((var8 - var9) * (modelViewportYs[var7] - modelViewportYs[var6]) - (var25 - var9) * (modelViewportYs[var5] - modelViewportYs[var6]) > 0) {
                     ...
                     if (var8 >= 0 && var9 >= 0 && var25 >= 0 && var8 <= Rasterizer3D.Rasterizer3D_clipWidth && var9 <= Rasterizer3D.Rasterizer3D_clipWidth && var25 <= Rasterizer3D.Rasterizer3D_clipWidth) {
                        field1896[var4] = false;
                     } else {
                        field1896[var4] = true;
                     }
