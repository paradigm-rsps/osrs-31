...
public class FileSystem {
   ...
   static final boolean method1517(int var0, int var1, int var2, int var3, boolean var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      ...
      int[][] var19 = Client.collisionMaps[class22.Client_plane].flags;
      ...
      while(var28 != var16) {
         ...
         if (var5 != 0) {
            if ((var5 < 5 || var5 == 10) && Client.collisionMaps[class22.Client_plane].method3438(var13, var14, var2, var3, var5 - 1, var6)) {
               var17 = true;
               break;
            }

            if (var5 < 10 && Client.collisionMaps[class22.Client_plane].method3444(var13, var14, var2, var3, var5 - 1, var6)) {
               var17 = true;
               break;
            }
         }

         if (var7 != 0 && var8 != 0 && Client.collisionMaps[class22.Client_plane].method3467(var13, var14, var2, var3, var7, var8, var9)) {
            var17 = true;
            break;
         }
