...
public class class27 extends class177 {
   ...
   public static ItemComposition method571(int var0) {
      ItemComposition var1 = (ItemComposition)ItemComposition.ItemDefinition_cached.method3474((long)var0);
      if (var1 != null) {
         return var1;
      } else {
         ...
         ItemComposition.ItemDefinition_cached.method3473(var1, (long)var0);
         return var1;
      }
   }
