...
public class Widget extends Node {
   ...
   public Font method3342() {
      ...
      if (this.fontId == -1) {
         ...
         Font var1 = (Font)Widget_cachedSpriteMasks.method3474((long)this.fontId);
         if (var1 != null) {
            return var1;
         } else {
            var1 = class82.method1757(Widget_spritesArchive, JagexCache.Widget_fontsArchive, this.fontId, 0);
            if (var1 != null) {
               Widget_cachedSpriteMasks.method3473(var1, (long)this.fontId);
            } else {
               field2574 = true;
            }
   ...
   public SpritePixels method3374(int var1) {
      ...
      if (var1 >= 0 && var1 < this.inventorySprites.length) {
         ...
         if (var2 == -1) {
            ...
            SpritePixels var3 = (SpritePixels)Widget_cachedModels.method3474((long)var2);
            if (var3 != null) {
               return var3;
            } else {
               ...
               if (var4 != null) {
                  Widget_cachedModels.method3473(var4, (long)var2);
               } else {
                  field2574 = true;
               }
   ...
   public Model method3351(SequenceDefinition var1, int var2, boolean var3, PlayerComposition var4) {
      ...
      if (var5 == 0) {
         ...
         Model var7 = (Model)Widget_cachedFonts.method3474((long)(var6 + (var5 << 16)));
         if (var7 == null) {
            ModelData var8;
            if (var5 == 1) {
            ...
            Widget_cachedFonts.method3473(var7, (long)(var6 + (var5 << 16)));
         }
