...
public final class IterableNodeHashTableIterator implements Runnable {
    ...
    public void run() {
        try {
            ...
            ScriptEvent.method3(null, var12);
        }
    ...
    static final void handleServerPacket() {
        ...
        if (Client.serverPacketOpcode == 182) {
            ...
            if (var37 >= 0 && playerIndex >= 0 && var37 < 103 && playerIndex < 103) {
                if (var4 == 0) {
                    BoundaryObject boundaryObject = Interpreter.scene.getBoundaryObject(class22.scenePlane, var37, playerIndex);
                    if (boundaryObject != null) {
                        id = boundaryObject.packedId >> 14 & 32767;
                        if (var2 == 2) {
                            boundaryObject.renderable1 = new DynamicObject(id, 2, var3 + 4, class22.scenePlane, var37, playerIndex, animationCycleEnd, false, boundaryObject.renderable1);
                            boundaryObject.renderable2 = new DynamicObject(id, 2, var3 + 1 & 3, class22.scenePlane, var37, playerIndex, animationCycleEnd, false, boundaryObject.renderable2);
                        } else {
                            boundaryObject.renderable1 = new DynamicObject(id, var2, var3, class22.scenePlane, var37, playerIndex, animationCycleEnd, false, boundaryObject.renderable1);
                        }
                    }
                }

                if (var4 == 1) {
                    WallDecoration wallDecoration = Interpreter.scene.getWallDecoration(class22.scenePlane, var37, playerIndex);
                    if (wallDecoration != null) {
                        id = wallDecoration.packedId >> 14 & 32767;
                        if (var2 != 4 && var2 != 5) {
                            if (var2 == 6) {
                                wallDecoration.renderable1 = new DynamicObject(id, 4, var3 + 4, class22.scenePlane, var37, playerIndex, animationCycleEnd, false, wallDecoration.renderable1);
                            } else if (var2 == 7) {
                                wallDecoration.renderable1 = new DynamicObject(id, 4, (var3 + 2 & 3) + 4, class22.scenePlane, var37, playerIndex, animationCycleEnd, false, wallDecoration.renderable1);
                            } else if (var2 == 8) {
                                wallDecoration.renderable1 = new DynamicObject(id, 4, var3 + 4, class22.scenePlane, var37, playerIndex, animationCycleEnd, false, wallDecoration.renderable1);
                                wallDecoration.renderable2 = new DynamicObject(id, 4, (var3 + 2 & 3) + 4, class22.scenePlane, var37, playerIndex, animationCycleEnd, false, wallDecoration.renderable2);
                            }
                        } else {
                            wallDecoration.renderable1 = new DynamicObject(id, 4, var3, class22.scenePlane, var37, playerIndex, animationCycleEnd, false, wallDecoration.renderable1);
                        }
                    }
                }

                if (var4 == 2) {
                    GameObject var42 = Interpreter.scene.getGameObject(class22.scenePlane, var37, playerIndex);
                    if (var2 == 11) {
                        var2 = 10;
                    }
            ...
            if (var35 >= 0 && var2 >= 0 && var35 < 104 && var2 < 104 && var3 != Client.localPlayerIndex) {
                ...
                var40.id = var36;
                var40.quantity = var4;
                if (Client.groundItems[class22.scenePlane][var35][var2] == null) {
                    Client.groundItems[class22.scenePlane][var35][var2] = new NodeDeque();
                }

                Client.groundItems[class22.scenePlane][var35][var2].method3528(var40);
            ...
            if (Client.serverPacketOpcode == 89) {
                ...
                if (var2 >= 0 && var3 >= 0 && var2 < 104 && var3 < 104) {
                    NodeDeque var33 = Client.groundItems[class22.scenePlane][var2][var3];
                    if (var33 != null) {
                        ...
                        if (var33.method3533() == null) {
                            Client.groundItems[class22.scenePlane][var2][var3] = null;
                        }
                ...
                if (Client.serverPacketOpcode == 70) {
                    ...
                    if (var2 >= 0 && var3 >= 0 && var2 < 104 && var3 < 104) {
                        ...
                        if (Client.groundItems[class22.scenePlane][var2][var3] == null) {
                            Client.groundItems[class22.scenePlane][var2][var3] = new NodeDeque();
                        }

                        Client.groundItems[class22.scenePlane][var2][var3].method3528(var32);
                        GameObject.method2205(var2, var3);
                    }
                    ...
                    if (Client.serverPacketOpcode == 65) {
                        ...
                        if (var36 >= 0 && var37 >= 0 && var36 < 104 && var37 < 104) {
                            class1.updatePendingSpawn(class22.scenePlane, var36, var37, var3, playerIndex, var35, var2, 0, -1);
                        }
                        ...
                        if (var35 >= 0 && var2 >= 0 && var35 < 104 && var2 < 104) {
                            class1.updatePendingSpawn(class22.scenePlane, var35, var2, var37, -1, var4, var36, 0, -1);
                        }
                        ...
                        if (var35 >= 0 && var2 >= 0 && var35 < 104 && var2 < 104 && var3 >= 0 && var4 >= 0 && var3 < 104 && var4 < 104 && var37 != 65535) {
                            ...
                            var3 = var3 * 128 + 64;
                            var4 = var4 * 128 + 64;
                            Projectile var30 = new Projectile(var37, class22.scenePlane, var35, var2, BufferedFile.getTileHeight(var35, var2, class22.scenePlane) - playerIndex, id + Client.cycle, face + Client.cycle, var11, var38, var36, var8);
                            var30.method114(var3, var4, BufferedFile.getTileHeight(var3, var4, class22.scenePlane) - var8, id + Client.cycle);
                        ...
                        if (var35 >= 0 && var2 >= 0 && var35 < 104 && var2 < 104) {
                            var35 = var35 * 128 + 64;
                            var2 = var2 * 128 + 64;
                            GraphicsObject var39 = new GraphicsObject(var3, class22.scenePlane, var35, var2, BufferedFile.getTileHeight(var35, var2, class22.scenePlane) - var4, var36, Client.cycle);
                    ...
                    var36 = Client.serverPacketBuf.readUnsignedShort();
                    if (var35 >= 0 && var2 >= 0 && var35 < 104 && var2 < 104) {
                        NodeDeque var29 = Client.groundItems[class22.scenePlane][var35][var2];
                        if (var29 != null) {
