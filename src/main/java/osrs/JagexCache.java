            ...
            try {
                    ...
                    for (var1 = 0; var1 < Client.playersCount; ++var1) {
                        ...
                        if ((var19 & 4) != 0) {
                            ...
                            if (var5 == var84.animation && var5 != -1) {
                                var7 = Definitions.getAnimation(var5).field901;
                                if (var7 == 1) {
                            ...
                            } else if (var5 == -1 || var84.animation == -1 || Definitions.getAnimation(var5).field895 >= Definitions.getAnimation(var84.animation).field895) {
                ...
                if (Client.serverPacketOpcode == 37) {
                    ...
                    if (SoundCache.field1206 >= 100) {
                        ...
                        class22.cameraY = BufferedFile.getTileHeight(Login.cameraX, class17.cameraZ, class22.scenePlane) - class5.field73;
                    }
                ...
                if (Client.serverPacketOpcode == 102) {
                    ...
                    ItemContainer var57 = (ItemContainer) ItemContainer.itemContainers.method3512(var2);
                    if (var57 != null) {
                ...
                if (Client.serverPacketOpcode == 216) {
                    ...
                    InterfaceParent var93 = (InterfaceParent) Client.interfaceParents.method3512(var1);
                    if (var93 != null) {
                ...
                if (Client.serverPacketOpcode == 1) {
                    ...
                    for (var1 = Actor.field478; var1 < Actor.field478 + 8; ++var1) {
                        for (var2 = GraphicsObject.field307; var2 < GraphicsObject.field307 + 8; ++var2) {
                            if (Client.groundItems[class22.scenePlane][var1][var2] != null) {
                                Client.groundItems[class22.scenePlane][var1][var2] = null;
                    ...
                    for (PendingSpawn var97 = (PendingSpawn) Client.pendingSpawns.method3533(); var97 != null; var97 = (PendingSpawn) Client.pendingSpawns.method3535()) {
                        if (var97.x >= Actor.field478 && var97.x < Actor.field478 + 8 && var97.y >= GraphicsObject.field307 && var97.y < GraphicsObject.field307 + 8 && var97.plane == class22.scenePlane) {
                            var97.hitpoints = 0;
                        }
                    }
                ...
                if (Client.serverPacketOpcode == 63) {
                    ...
                    var31 = Client.serverPacketBuf.readUnsignedShort();
                    var20 = Client.serverPacketBuf.readMedium();
                ...
                if (Client.serverPacketOpcode == 153) {
                    var28 = Client.serverPacketBuf.readChatString();
                    var29 = Client.serverPacketBuf.readUnsignedShort();
                    var31 = Client.serverPacketBuf.readMedium();
                    var6 = Client.serverPacketBuf.readUnsignedByte();
                ...
                if (Client.serverPacketOpcode == 66) {
                    ...
                    var2 = Client.serverPacketBuf.readUnsignedShort();
                    var3 = Client.serverPacketBuf.readUnsignedByte();
                    var53 = (InterfaceParent) Client.interfaceParents.method3512(var1);
                    if (var53 != null) {
                    ...
                    var75.group = var2;
                    var75.field56 = var3;
                    Client.interfaceParents.method3517(var75, var1);
                    Tiles.method99(var2);
                ...
                if (Client.serverPacketOpcode == 135) {
                    ...
                    if (class65.field1268 >= 100) {
                        ...
                        var3 = BufferedFile.getTileHeight(var1, var2, class22.scenePlane) - SceneTilePaint.field1681;
                        var19 = var1 - Login.cameraX;
                        var5 = var3 - class22.cameraY;
                        var6 = var2 - class17.cameraZ;
                        var7 = (int) Math.sqrt(var19 * var19 + var6 * var6);
                        NPC.cameraPitch = (int) (Math.atan2(var5, var7) * 325.949D) & 2047;
                        MouseRecorder.cameraYaw = (int) (Math.atan2(var19, var6) * -325.949D) & 2047;
                ...
                if (Client.serverPacketOpcode == 99) {
                    ...
                    for (; var3-- > 0; var92.field54 = true) {
                        ...
                        var5 = Client.serverPacketBuf.readUnsignedShort();
                        var6 = Client.serverPacketBuf.readUnsignedByte();
                        var92 = (InterfaceParent) Client.interfaceParents.method3512(var19);
                        ...
                        if (var92 == null) {
                            ...
                            var82.group = var5;
                            var82.field56 = var6;
                            Client.interfaceParents.method3517(var82, var19);
                            Tiles.method99(var5);
                ...
                ScriptEvent.method3("" + Client.serverPacketOpcode + "," + Client.field728 + "," + Client.field488 + "," + Client.serverPacketLength, null);
                Canvas.method1655();
