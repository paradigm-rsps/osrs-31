...
public class AudioFilter {
    ...
    int method1419(int var1, float var2) {
        ...
        if (var1 == 0) {
            ...
            var3 *= 0.0030517578F;
            field1244 = (float) Math.pow(0.1D, var3 / 20.0F);
        ...
        if (this.pairs[var1] == 0) {
            ...
            field1247[var1][0] = -2.0F * var3 * (float) Math.cos(this.method1424(var1, 0, var2));
            field1247[var1][1] = var3 * var3;

            int var4;
            for (var4 = 1; var4 < this.pairs[var1]; ++var4) {
                var3 = this.method1417(var1, var4, var2);
                float var5 = -2.0F * var3 * (float) Math.cos(this.method1424(var1, var4, var2));
