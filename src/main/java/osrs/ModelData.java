...
public class ModelData extends Renderable {
    @ObfuscatedName("ag")
    static int[] field1728 = new int[10000];
    @ObfuscatedName("ap")
    static int[] field1729 = new int[10000];
    @ObfuscatedName("am")
    static int field1730 = 0;
    @ObfuscatedName("as")
    ...
    public ModelData(ModelData[] var1, int var2) {
        ...
        if (this.textureTriangleCount > 0) {
            ...
            this.field1694 = new short[this.textureTriangleCount];
            this.field1707 = new short[this.textureTriangleCount];
            this.field1706 = new short[this.textureTriangleCount];
            this.field1709 = new short[this.textureTriangleCount];
            this.field1712 = new byte[this.textureTriangleCount];
            this.field1731 = new short[this.textureTriangleCount];
            this.field1711 = new short[this.textureTriangleCount];
        }
        ...
        for (var9 = 0; var9 < var2; ++var9) {
            ...
            if (var10 != null) {
                ...
                for (var11 = 0; var11 < var10.faceCount; ++var11) {
                    ...
                    this.indices1[this.faceCount] = this.method2216(var10, var10.indices1[var11]);
                    this.indices2[this.faceCount] = this.method2216(var10, var10.indices2[var11]);
                    this.indices3[this.faceCount] = this.method2216(var10, var10.indices3[var11]);
                    ++this.faceCount;
                }
                ...
                for (var11 = 0; var11 < var10.textureTriangleCount; ++var11) {
                    ...
                    if (var12 == 0) {
                        this.texTriangleX[this.textureTriangleCount] = (short) this.method2216(var10, var10.texTriangleX[var11]);
                        this.texTriangleY[this.textureTriangleCount] = (short) this.method2216(var10, var10.texTriangleY[var11]);
                        this.texTriangleZ[this.textureTriangleCount] = (short) this.method2216(var10, var10.texTriangleZ[var11]);
                    }
                    ...
                    if (var12 >= 1 && var12 <= 3) {
                        ...
                        this.field1694[this.textureTriangleCount] = var10.field1694[var11];
                        this.field1707[this.textureTriangleCount] = var10.field1707[var11];
                        this.field1706[this.textureTriangleCount] = var10.field1706[var11];
                        this.field1709[this.textureTriangleCount] = var10.field1709[var11];
                        this.field1712[this.textureTriangleCount] = var10.field1712[var11];
                        this.field1731[this.textureTriangleCount] = var10.field1731[var11];
                    }

                    if (var12 == 2) {
                        this.field1711[this.textureTriangleCount] = var10.field1711[var11];
                    }
    ...
    ModelData(byte[] var1) {
        if (var1[var1.length - 1] == -1 && var1[var1.length - 2] == -1) {
            ...
            this.method2215(var1);
        }

    }

    @ObfuscatedSignature(
            descriptor = "(Lclass100;ZZZZ)V"
    )
    ...
    void method2214(byte[] var1) {
        ...
        for (var51 = 0; var51 < var9; ++var51) {
            ...
            var54 = 0;
            if ((var52 & 2) != 0) {
                var54 = var4.method2657();
            }

            var55 = 0;
            if ((var52 & 4) != 0) {
                var55 = var5.method2657();
            }
    ...
    void method2215(byte[] var1) {
        ...
        for (var38 = 0; var38 < var9; ++var38) {
            ...
            var41 = 0;
            if ((var39 & 2) != 0) {
                var41 = var6.method2657();
            }

            var42 = 0;
            if ((var39 & 4) != 0) {
                var42 = var7.method2657();
            }
    ...
    @ObfuscatedName("t")
    @ObfuscatedSignature(
            descriptor = "(Lclass100;I)I"
    )
    final int method2216(ModelData var1, int var2) {
        int var3 = -1;
    ...
    @ObfuscatedName("l")
    @ObfuscatedSignature(
            descriptor = "([[IIIIZI)Lclass100;"
    )
    public ModelData method2218(int[][] var1, int var2, int var3, int var4, boolean var5, int var6) {
        this.method2291();
        int var7 = var2 + this.field1724;
        int var8 = var2 + this.field1715;
        int var9 = var4 + this.field1701;
        int var10 = var4 + this.field1686;
    ...
    @ObfuscatedName("u")
    public void method2228(int var1) {
    ...
    @ObfuscatedName("g")
    @Export("method2223")
    public void method2223(int var1, int var2, int var3) {
        for (int var4 = 0; var4 < this.verticesCount; ++var4) {
    ...
    @ObfuscatedName("v")
    @Export("method2236")
    public void method2236(short var1, short var2) {
    ...
    @ObfuscatedName("n")
    @Export("method2287")
    public void method2287(int var1, int var2, int var3) {
        for (int var4 = 0; var4 < this.verticesCount; ++var4) {
    ...
    @Export("method2282")
    @ObfuscatedSignature(
            descriptor = "(IIIII)Lclass111;"
    )
    public final Model method2282(int var1, int var2, int var3, int var4, int var5) {
        this.method2271();
        ...
        if (this.textureTriangleCount > 0 && this.textureCoords != null) {
            ...
            var8.field1892 = new int[var8.field1914];
            var8.field1884 = new int[var8.field1914];
            var8.field1885 = new int[var8.field1914];
            var10 = 0;

            int var11;
            for (var11 = 0; var11 < this.textureTriangleCount; ++var11) {
                if (var9[var11] > 0 && this.textureRenderTypes[var11] == 0) {
                    var8.field1892[var10] = this.texTriangleX[var11] & '\uffff';
                    var8.field1884[var10] = this.texTriangleY[var11] & '\uffff';
                    var8.field1885[var10] = this.texTriangleZ[var11] & '\uffff';
                    var9[var11] = var10++;
                } else {
                    var9[var11] = -1;
                }
            ...
            var8.field1879 = new byte[this.faceCount];

            for (var11 = 0; var11 < this.faceCount; ++var11) {
                if (this.textureCoords[var11] != -1) {
                    var8.field1879[var11] = (byte) var9[this.textureCoords[var11] & 255];
                } else {
            ...
            if (var12 == -1) {
                if (var17 != 0) {
                    if (var17 == 1) {
                        ...
                        var8.faceColors1[var16] = method2232(this.faceColors[var16] & '\uffff', var14);
                    ...
                    var8.faceColors1[var16] = method2232(var15, var14);
                    ...
                    var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
                    var8.faceColors2[var16] = method2232(var15, var14);
                    ...
                    var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
                    var8.faceColors3[var16] = method2232(var15, var14);
                }
            } else if (var17 != 0) {
                if (var17 == 1) {
                    var19 = this.faceNormals[var16];
                    var14 = (var4 * var19.y + var5 * var19.z + var3 * var19.x) / (var7 / 2 + var7) + var1;
                    var8.faceColors1[var16] = method2233(var14);
                    var8.faceColors3[var16] = -1;
                } else {
                    var8.faceColors3[var16] = -2;
                }
                ...
                var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
                var8.faceColors2[var16] = method2233(var14);
                if (this.vertexVertices != null && this.vertexVertices[this.indices3[var16]] != null) {
                    var13 = this.vertexVertices[this.indices3[var16]];
                } else {
                    var13 = this.vertexNormals[this.indices3[var16]];
                ...
                var14 = (var4 * var13.y + var5 * var13.z + var3 * var13.x) / (var7 * var13.magnitude) + var1;
                var8.faceColors3[var16] = method2233(var14);
            }
        }
    ...
    @Export("method2222")
    @ObfuscatedSignature(
            descriptor = "(Lclass151;II)Lclass100;"
    )
    public static ModelData method2222(AbstractArchive var0, int var1, int var2) {
    ...
    @ObfuscatedName("b")
    @ObfuscatedSignature(
            descriptor = "(Lclass100;Lclass100;IIIZ)V"
    )
    static void method2231(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
        var0.method2291();
        var0.method2271();
        var1.method2291();
        var1.method2271();
        ...
        for (var9 = 0; var9 < var0.verticesCount; ++var9) {
            ...
            if (var10.magnitude != 0) {
                ...
                if (var11 <= var1.field1723) {
                    int var12 = var0.verticesX[var9] - var2;
                    if (var12 >= var1.field1724 && var12 <= var1.field1715) {
                        int var13 = var0.verticesZ[var9] - var4;
                        if (var13 >= var1.field1701 && var13 <= var1.field1686) {
                            for (int var14 = 0; var14 < var8; ++var14) {
                                ...
                                if (var12 == var7[var14] && var13 == var1.verticesZ[var14] && var11 == var1.verticesY[var14] && var15.magnitude != 0) {
                                    ...
                                    ++var6;
                                    field1728[var9] = field1730;
                                    field1729[var14] = field1730;
                                }
                            }
                        }
                    }
        ...
        if (var6 >= 3 && var5) {
            for (var9 = 0; var9 < var0.faceCount; ++var9) {
                if (field1728[var0.indices1[var9]] == field1730 && field1728[var0.indices2[var9]] == field1730 && field1728[var0.indices3[var9]] == field1730) {
            ...
            for (var9 = 0; var9 < var1.faceCount; ++var9) {
                if (field1730 == field1729[var1.indices1[var9]] && field1730 == field1729[var1.indices2[var9]] && field1730 == field1729[var1.indices3[var9]]) {
    ...
    @ObfuscatedName("x")
    static final int method2232(int var0, int var1) {
    ...
    @ObfuscatedName("ao")
    static final int method2233(int var0) {
        if (var0 < 2) {
            var0 = 2;
        } else if (var0 > 126) {
            var0 = 126;
