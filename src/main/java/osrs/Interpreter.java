...
public class Interpreter {
    ...
    static final void method275(int var0, int var1, int var2, int var3) {
        ...
        for (Projectile var4 = (Projectile) Client.field619.method3533(); var4 != null; var4 = (Projectile) Client.field619.method3535()) {
            if (var4.plane == class22.scenePlane && Client.cycle <= var4.cycleEnd) {
                if (Client.cycle >= var4.cycleStart) {
                    ...
                    scene.method2094(class22.scenePlane, (int) var4.x, (int) var4.y, (int) var4.z, 60, var4, var4.yaw, -1, false);
                }
            } else {
                var4.remove();
            }
        ...
        for (GraphicsObject var35 = (GraphicsObject) Client.field620.method3533(); var35 != null; var35 = (GraphicsObject) Client.field620.method3535()) {
            if (var35.plane == class22.scenePlane && !var35.isFinished) {
        ...
        if (!Client.isCameraLocked) {
            ...
            SceneTilePaint.method2210(Client.field572, BufferedFile.getTileHeight(Tiles.localPlayer.x, Tiles.localPlayer.y, class22.scenePlane) - 50, MouseHandler.field1402, var25, var5, var25 * 3 + 600);
        }
        ...
        if (!Client.field489 && !Client.isMenuOpen && var10 >= var0 && var10 < var0 + var2 && var11 >= var1 && var11 < var3 + var1) {
            ...
            for (var13 = 0; var13 < Model.field1920; ++var13) {
                ...
                if (var26 != var12) {
                    ...
                    if (var37 == 3) {
                        NodeDeque var40 = Client.groundItems[class22.scenePlane][var15][var16];
                        if (var40 != null) {
