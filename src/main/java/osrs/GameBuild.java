...
public class GameBuild {
    ...
    public static ObjectComposition getObjectComposition(int var0) {
        ObjectComposition var1 = (ObjectComposition) ObjectComposition.ObjectDefinition_cached.method3474(var0);
        if (var1 != null) {
            return var1;
        } else {
            ...
            ObjectComposition.ObjectDefinition_cached.method3473(var1, var0);
            return var1;
        }
    }
    ...
    public static VarpDefinition method2854(int var0) {
        VarpDefinition var1 = (VarpDefinition) VarpDefinition.VarpDefinition_cached.method3474(var0);
        if (var1 != null) {
            return var1;
        } else {
            ...
            VarpDefinition.VarpDefinition_cached.method3473(var1, var0);
            return var1;
        }
    }
