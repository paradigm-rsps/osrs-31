...
public abstract class Renderable extends DualNode {
    ...
    static void method2040(ScriptEvent var0) {
        ...
        if (var3 != null) {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (var46 < 100) {
                        ...
                        if (var46 == ScriptOpcodes.SET_VARBIT) {
                            ...
                            VarbitComposition var68 = (VarbitComposition) VarbitComposition.VarbitDefinition_cached.method3474(var13);
                            ...
                            if (var68 != null) {
                                ...
                                VarbitComposition.VarbitDefinition_cached.method3473(var68, var13);
                                var75 = var68;
                            }
                                ...
                                if (var46 >= 1300 && var46 < 1400 || var46 >= 2300 && var46 < 2400) {
                                    ...
                                    if (var46 < 1600) {
                                        ...
                                        if (var46 == ScriptOpcodes.IF_HASSUB) {
                                            --var4;
                                            var14 = Interpreter.Interpreter_intStack[var4];
                                            InterfaceParent var47 = (InterfaceParent) Client.interfaceParents.method3512(var14);
                                            if (var47 != null) {
                                                Interpreter.Interpreter_intStack[var4++] = 1;
                                            } else {
                                                Interpreter.Interpreter_intStack[var4++] = 0;
                                        ...
                                        if (var46 < 3200) {
                                            ...
                                            if (var46 == ScriptOpcodes.RESUME_COUNTDIALOG) {
                                                ...
                                                Client.rsaBuf.writeByteOpcode(163);
                                            ...
                                            if (var46 == ScriptOpcodes.RESUME_NAMEDIALOG) {
                                                --var5;
                                                var97 = Interpreter.Interpreter_stringStack[var5];
                                                Client.rsaBuf.writeByteOpcode(104);
                                                Client.rsaBuf.writeByte(var97.length() + 1);
                                                Client.rsaBuf.writeStringCp1252NullTerminated(var97);
                                                continue;
                                            }
                                            ...
                                            if (var46 == ScriptOpcodes.RESUME_STRINGDIALOG) {
                                                --var5;
                                                var97 = Interpreter.Interpreter_stringStack[var5];
                                                Client.rsaBuf.writeByteOpcode(180);
                                                Client.rsaBuf.writeByte(var97.length() + 1);
                                                Client.rsaBuf.writeStringCp1252NullTerminated(var97);
                                                continue;
                                            }
                                                ...
                                                for (var33 = 0; var33 < Client.field604; ++var33) {
                                                    ...
                                                    if (var37 != null && var37.field35 != null && var37.field35.equalsIgnoreCase(var15)) {
                                                        ...
                                                        if (var14 == ScriptOpcodes.GET_VARP) {
                                                            ...
                                                            Client.rsaBuf.writeShortAdd(Client.field524[var33]);
                                            ...
                                            if (var46 == ScriptOpcodes.INV_GETOBJ) {
                                                ...
                                                var33 = var4++;
                                                var36 = (ItemContainer) ItemContainer.itemContainers.method3512(var14);
                                                if (var36 == null) {
                                                    var18 = -1;
                                            ...
                                            if (var46 == ScriptOpcodes.STAFFMODLEVEL) {
                                                if (Client.privilegeLevel >= 2) {
                                                    Interpreter.Interpreter_intStack[var4++] = Client.privilegeLevel;
                                                } else {
                                                    Interpreter.Interpreter_intStack[var4++] = 0;
                                                }
                                                continue;
                                            ...
                                            if (var46 < 3700) {
                                                ...
                                                if (var46 == ScriptOpcodes.IGNORE_ADD) {
                                                    ...
                                                    if ((Client.field534 < 100 || Client.isMember == 1) && Client.field534 < 400) {
                                                ...
                                                if (var46 == ScriptOpcodes.IGNORE_DEL) {
                                                    ...
                                                    while (true) {
                                                        ...
                                                        if (BufferedFile.method599(var97, var15, var88, var84)) {
                                                            ...
                                                            Client.rsaBuf.writeByteOpcode(250);
                                                ...
                                                if (var46 == ScriptOpcodes.POW) {
                                                    ...
                                                    if (var14 == 0) {
                                                        ...
                                                        Interpreter.Interpreter_intStack[var4++] = (int) Math.pow(var14, var39);
                                                    }
                                                    continue;
                                                }
                                                ...
                                                if (var46 == ScriptOpcodes.INVPOW) {
                                                    ...
                                                    if (var14 == 0) {
                                                        ...
                                                        Interpreter.Interpreter_intStack[var4++] = (int) Math.pow(var14, 1.0D / (double) var39);
                                                    }
                                                    continue;
                                                }
                                                ...
                                                if (var46 == ScriptOpcodes.CHAT_SETFILTER) {
                                                    ...
                                                    Client.rsaBuf.writeByteOpcode(91);
                                                ...
                                                if (var46 == ScriptOpcodes.CHAT_SENDABUSEREPORT) {
                                                    ...
                                                    var39 = Interpreter.Interpreter_intStack[var4];
                                                    var35 = Interpreter.Interpreter_intStack[var4 + 1];
                                                    Client.rsaBuf.writeByteOpcode(193);
                                                ...
                                                if (var46 == ScriptOpcodes.CHAT_SENDPUBLIC) {
                                                    ...
                                                    if (var97.startsWith("::")) {
                                                        ...
                                                        Client.rsaBuf.writeByteOpcode(210);
                                                        Client.rsaBuf.writeByte(var97.length() - 1);
                                                        Client.rsaBuf.writeStringCp1252NullTerminated(var97.substring(2));
                                                        continue;
                                                    }
                                                    ...
                                                    Client.rsaBuf.writeByteOpcode(46);
                                                    ...
                                                    Client.rsaBuf.writeLengthByte(Client.rsaBuf.offset - var18);
                                                    continue;
                                                }
                ...
                var44.append(var3.key).append(" ");

                for (var12 = Interpreter.Interpreter_frameDepth - 1; var12 >= 0; --var12) {
                    var44.append(Interpreter.Interpreter_frames[var12].field279.key).append(" ");
                }
    ...
    static final int method2038() {
        if (Projectile.clientPreferences.roofsHidden) {
            ...
            int var0 = BufferedFile.getTileHeight(Login.cameraX, class17.cameraZ, class22.scenePlane);
            return var0 - class22.cameraY < 800 && (Tiles.Tiles_renderFlags[class22.scenePlane][Login.cameraX >> 7][class17.cameraZ >> 7] & 4) != 0 ? class22.scenePlane : 3;
        }
    }
}
