...
public final class KeyHandler implements KeyListener, FocusListener {
    ...
    static final void method1649() {
        ...
        int var2 = BufferedFile.getTileHeight(var0, var1, class22.scenePlane) - class5.field73;
        ...
        var2 = BufferedFile.getTileHeight(var0, var1, class22.scenePlane) - SceneTilePaint.field1681;
        int var3 = var0 - Login.cameraX;
        int var4 = var2 - class22.cameraY;
        int var5 = var1 - class17.cameraZ;
        int var6 = (int) Math.sqrt(var3 * var3 + var5 * var5);
