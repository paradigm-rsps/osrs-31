...
public final class Font extends AbstractFont {
    ...
    final void vmethod3669(byte[] var1, int var2, int var3, int var4, int var5, int var6) {
        ...
        if (var4 > 0 && var5 > 0) {
            AbstractFont.method3621(Rasterizer2D.Rasterizer2D_pixels, var1, var6, var10, var7, var4, var5, var8, var9);
        }
    }
    ...
    final void vmethod3619(byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7) {
        ...
        if (var4 > 0 && var5 > 0) {
            AbstractFont.method3623(Rasterizer2D.Rasterizer2D_pixels, var1, var6, var11, var8, var4, var5, var9, var10, var7);
        }
    }
}
