...
public class EnumComposition extends DualNode {
    ...
    static void method851(Archive var0, int var1) {
        if (WallDecoration.NetCache_reference != null) {
            ...
            class148.method3173(null, 255, 255, 0, (byte) 0, true);
        ...
        for (int var1 = 0; var1 < Client.npcCount; ++var1) {
            ...
            if (var2 != null && var2.vmethod281() && var2.definition.field808 == var0 && var2.definition.method634()) {
                ...
                if (var4 >= 0 && var4 < 104 && var5 >= 0 && var5 < 104) {
                    ...
                    Interpreter.scene.method2094(class22.scenePlane, var2.x, var2.y, BufferedFile.getTileHeight(var2.size * 64 - 64 + var2.x, var2.size * 64 - 64 + var2.y, class22.scenePlane), var2.size * 64 - 64 + 60, var2, var2.field432, var3, var2.isWalking);
                }
            }
        }
