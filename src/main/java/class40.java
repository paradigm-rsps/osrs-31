            ...
            if (!var9.isIf3 || var12 < var14 && var13 < var15) {
               if (var9.contentType == 1337) {
                  ...
                  if (var9.isIf3) {
                     ...
                     boolean var27 = false;
                     if (MouseHandler.MouseHandler_currentButton == 1 && var26) {
                        var27 = true;
                     }

                     boolean var28 = false;
                     if (MouseHandler.PacketBufferNode_packetBufferNodeCount == 1 && MouseHandler.MouseHandler_lastPressedX >= var12 && MouseHandler.MouseHandler_lastPressedY >= var13 && MouseHandler.MouseHandler_lastPressedX < var14 && MouseHandler.MouseHandler_lastPressedY < var15) {
                        var28 = true;
                     }
