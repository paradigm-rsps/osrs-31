      ...
      if (Client.field717 != 2 && Client.field717 != 5) {
         ...
         for(var6 = 0; var6 < 104; ++var6) {
            for(var7 = 0; var7 < 104; ++var7) {
               NodeDeque var15 = Client.groundItems[class22.Client_plane][var6][var7];
               if (var15 != null) {
         ...
         for(var6 = 0; var6 < Client.field604; ++var6) {
            ...
            if (var19 != null && var19.vmethod281()) {
               ...
               boolean var16 = false;
               if (ItemContainer.method203(var19.field35)) {
                  var16 = true;
               }
               ...
               boolean var17 = false;
               if (Tiles.localPlayer.team != 0 && var19.team != 0 && var19.team == Tiles.localPlayer.team) {
                  var17 = true;
               }
