...
public class ItemComposition extends DualNode {
   ...
   public final Model method886(int var1) {
      ...
      Model var5 = (Model)ItemDefinition_cachedModels.method3474((long)this.id);
      if (var5 != null) {
         return var5;
      } else {
         ...
         if (var6 == null) {
            ...
            ItemDefinition_cachedModels.method3473(var5, (long)this.id);
            return var5;
         }
      }
   }
   ...
   public final boolean method862(boolean var1) {
      ...
      if (var2 == -1) {
         ...
         boolean var5 = true;
         if (!ItemDefinition_modelArchive.method3206(var2, 0)) {
            var5 = false;
         }
